        ...
        <div className={className}>  
            {videos.length !== 0 ?
                <table className='table-auto'>
                    ...
                    <tbody>
                        {videos.map((video) => (
                            <tr key={video._id} className='content_panel_body_text border-t border-t-solid border-t-stone-300'>
                                ...
                                <td className="w-80">
                                    <div className='text-ellipsis whitespace-nowrap overflow-auto'>
                                        <p className="content_panel_body_text w-16">{video.title}</p>
                                        <p className="italic w-16">{video.description}</p>
                                    </div>
                                </td>
                                {role.content_manager ?
                                    <>
                                ...
                                <td className="px-2 truncate xs:hidden">
